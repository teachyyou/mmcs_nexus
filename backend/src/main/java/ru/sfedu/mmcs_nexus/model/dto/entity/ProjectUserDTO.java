...
public class ProjectUserDTO {
    ...
    private final boolean captainMine;
    ...
    public ProjectUserDTO(Project project, User currentUser) {
        ...
        this.captainUserFullName = captain != null
                ? buildFullName(captain)
                : null;

        this.captainMine = captain != null
                && currentUser != null
                && captain.getId().equals(currentUser.getId());
    }
